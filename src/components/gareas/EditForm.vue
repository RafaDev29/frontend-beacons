<template>
    <div v-if="editedItem" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
        <div class="bg-white rounded-lg shadow-2xl max-w-4xl w-full p-8">
            <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">Editar Área</h2>
            <form @submit.prevent="submitUpdate">
                ...
                <div class="mb-6">
                    ...
                    <input 
                        ...
                        class="w-full border border-gray-300 rounded-lg py-3 px-4 text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400"
                    ...
                    <div class="w-1/2 bg-gray-50 border border-gray-300 rounded-lg shadow p-4">
                        ...
                        >
                            <div 
                                ...
                                :key="tag._id" 
                                class="bg-blue-50 border border-blue-200 rounded-lg p-2 mb-2 shadow-md cursor-pointer hover:bg-blue-100 transition"
                                draggable="true"
